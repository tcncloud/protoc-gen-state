...
class Graph extends React.Component<ReduxProps, {}> {
  ...
  render() {
    ...
    return (
      <div style={{background: 'tan', marginTop: '-18px', paddingTop: '30px', paddingBottom:'30px'}} className="App">
