...
const createNodeEpic: Epic<RootAction, RootState> = (action$) => action$
...
const deleteNodeEpic: Epic<RootAction, RootState> = (action$) => action$
...
const updateNodeEpic: Epic<RootAction, RootState> = (action$) => action$
