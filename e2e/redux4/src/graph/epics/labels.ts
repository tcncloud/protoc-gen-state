...
const createLabelEpic: Epic<RootAction, RootState> = (action$) => action$
...
const deleteLabelEpic: Epic<RootAction, RootState> = (action$) => action$
...
const updateLabelEpic: Epic<RootAction, RootState> = (action$) => action$
