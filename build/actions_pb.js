...
export const getBookOfTheMonthRequest = createAction('PROTOC_GET_BOOKOFTHEMONTH_REQUEST', (resolve) => {
    return (bookOfTheMonth) => resolve(bookOfTheMonth);
});
export const getBookOfTheMonthRequestPromise = createAction('PROTOC_GET_BOOKOFTHEMONTH_REQUEST_PROMISE', (resolve) => {
    return (bookOfTheMonth, resolve, reject) => res({ bookOfTheMonth, resolve, reject });
});
...
export const getTimeoutBookRequest = createAction('PROTOC_GET_TIMEOUTBOOK_REQUEST', (resolve) => {
    return (timeoutBook) => resolve(timeoutBook);
});
export const getTimeoutBookRequestPromise = createAction('PROTOC_GET_TIMEOUTBOOK_REQUEST_PROMISE', (resolve) => {
    return (timeoutBook, resolve, reject) => res({ timeoutBook, resolve, reject });
});
...
export const listLibraryRequest = createAction('PROTOC_LIST_LIBRARY_REQUEST', (resolve) => {
    return (library) => resolve(library);
});
export const listLibraryRequestPromise = createAction('PROTOC_LIST_LIBRARY_REQUEST_PROMISE', (resolve) => {
    return (library, resolve, reject) => res({ library, resolve, reject });
});
...
export const createLibraryRequestPromise = createAction('PROTOC_CREATE_LIBRARY_REQUEST_PROMISE', (resolve) => {
    return (library, resolve, reject) => res({ library, resolve, reject });
});
...
export const createBookOfTheMonthRequestPromise = createAction('PROTOC_CREATE_BOOKOFTHEMONTH_REQUEST_PROMISE', (resolve) => {
    return (bookOfTheMonth, resolve, reject) => res({ bookOfTheMonth, resolve, reject });
});
...
export const deleteLibraryRequestPromise = createAction('PROTOC_DELETE_LIBRARY_REQUEST_PROMISE', (resolve) => {
    return (library, resolve, reject) => res({ library, resolve, reject });
});
...
export const deleteBookOfTheMonthRequestPromise = createAction('PROTOC_DELETE_BOOKOFTHEMONTH_REQUEST_PROMISE', (resolve) => {
    return (bookOfTheMonth, resolve, reject) => res({ bookOfTheMonth, resolve, reject });
});
...
export const deleteTimeoutBookRequest = createAction('PROTOC_DELETE_TIMEOUTBOOK_REQUEST', (resolve) => {
    return (timeoutBook) => resolve(timeoutBook);
});
export const deleteTimeoutBookRequestPromise = createAction('PROTOC_DELETE_TIMEOUTBOOK_REQUEST_PROMISE', (resolve) => {
    return (timeoutBook, resolve, reject) => res({ timeoutBook, resolve, reject });
});
...
export const updateLibraryRequest = createAction('PROTOC_UPDATE_LIBRARY_REQUEST', (resolve) => {
    return (prev, updated) => resolve({ prev, updated });
});
export const updateLibraryRequestPromise = createAction('PROTOC_UPDATE_LIBRARY_REQUEST_PROMISE', (res) => {
    return (prev, updated, resolve, reject) => res({ prev, updated, resolve, reject });
});
...
export const updateTimeoutBookRequest = createAction('PROTOC_UPDATE_TIMEOUTBOOK_REQUEST', (resolve) => {
    return (prev, updated) => resolve({ prev, updated });
});
export const updateTimeoutBookRequestPromise = createAction('PROTOC_UPDATE_TIMEOUTBOOK_REQUEST_PROMISE', (res) => {
    return (prev, updated, resolve, reject) => res({ prev, updated, resolve, reject });
});
...
export const customErrorBookRequest = createAction('PROTOC_CUSTOM_ERRORBOOK_REQUEST', (resolve) => {
    return (errorBook) => resolve(errorBook);
});
export const customErrorBookRequestPromise = createAction('PROTOC_CUSTOM_ERRORBOOK_REQUEST_PROMISE', (resolve) => {
    return (errorBook, resolve, reject) => res({ errorBook, resolve, reject });
});
