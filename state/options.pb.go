...
func (StateMessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_options_85ce0165ea272e69, []int{0}
}
...
func (OutputTypes) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_options_85ce0165ea272e69, []int{1}
}
...
func (*StateMessageOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_options_85ce0165ea272e69, []int{2}
}
...
func (*StateFieldOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_options_85ce0165ea272e69, []int{3}
}
...
func (*StateFileOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_options_85ce0165ea272e69, []int{4}
}
...
func init() { proto.RegisterFile("state/options.proto", fileDescriptor_options_85ce0165ea272e69) }

var fileDescriptor_options_85ce0165ea272e69 = []byte{
