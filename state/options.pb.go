...
func (m *StateFieldOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StateFieldOptions.Merge(m, src)
}
...
func (*StateFileOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd31485b9150be4d, []int{4}
}
...
var E_StateOptions = &proto.ExtensionDesc{
	...
	Tag:           "bytes,550002,opt,name=state_options",
...
var E_StateFieldOptions = &proto.ExtensionDesc{
	...
	Tag:           "bytes,550001,opt,name=state_field_options",
	Filename:      "state/options.proto",
}
...
var E_StateFileOptions = &proto.ExtensionDesc{
	...
	Tag:           "bytes,550003,opt,name=state_file_options",
	Filename:      "state/options.proto",
}
